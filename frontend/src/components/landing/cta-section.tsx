...
export function CTASection() {
  return (
    <section className="bg-white px-4 py-20 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-700 via-purple-700 to-blue-700 p-8 text-center text-white shadow-2xl shadow-indigo-900/20 sm:p-12">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-indigo-100">
          Build a professional academic outreach workflow with professor discovery, AI writing, scholarship tracking, and email analytics in one place.
        </p>
