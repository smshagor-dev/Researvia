...
import { Search, Loader2, ChevronLeft, ChevronRight, Shield, Ban, Coins } from 'lucide-react';
...
export default function AdminUsersPage() {
  ...
  const { data, isLoading } = useAdminUsers({ search, page, perPage: 25 });
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">{meta.total.toLocaleString()} total users</p>
        </div>
