...
- [x] Advanced operational tests and observability.
  - Evidence: operational-health and deliverability integration suites, queue/provider/feed/mail/push health signals, high-severity dependency audit gate, Node 24 CI, Playwright Chromium browser gate, and Mongoose 9 compatibility cleanup.
