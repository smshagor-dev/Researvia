...
export const savedItemTypeSchema = z.enum(["PROFESSOR", "UNIVERSITY", "SCHOLARSHIP", "OPPORTUNITY"]);
...
export const createSavedItemSchema = z.object({
  ...
  collection: z.string().trim().min(1).max(80).optional().default("Saved"),
...
export const savedItemQuerySchema = z.object({
  itemType: z.union([z.literal(""), savedItemTypeSchema]).optional().default(""),
